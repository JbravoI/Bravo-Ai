...
| [Epic 01](epic-01-app-skeleton/index.md) | App Skeleton | `Completed` | Next.js app (`app/`, `components/`, `context/`) |
| [Epic 02](epic-02-backend-data-model/index.md) | Backend And Data Model | `Ongoing` | `app/api/**`, `lib/data.ts`, Postgres (not yet provisioned) |
| [Epic 03](epic-03-auth-persistence/index.md) | Auth And Persistence | `Pending` | Auth.js (or equivalent), `app/api/**` |
| [Epic 04](epic-04-secure-ai-qa/index.md) | Secure AI Q&A | `Pending` | `app/api/query/route.ts`, Anthropic API |
| [Epic 05](epic-05-real-ingestion/index.md) | Real Regulatory-Source Ingestion | `Pending` | `app/api/scan/route.ts`, scheduled job |
