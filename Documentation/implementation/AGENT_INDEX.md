...
| Epic 04 Secure AI Q&A | `Pending` | Provider chosen (Anthropic, see `../docs/decisions/0002-anthropic-server-side-ai.md`); not implemented. `/api/query` currently returns `501`. Auth now exists if the endpoint needs to require sign-in. |
