...
| :--- | :--- | :--- | :--- | :--- |
| Authentication | `features/00-auth/authentication.md` | `../features/00-auth/authentication.feature` | `../implementation/epic-03-auth-persistence/` | `app/src/auth.ts`, `app/src/proxy.ts`, `app/src/lib/users.ts`, `app/src/app/login/page.tsx`, `app/src/app/signup/page.tsx`, `app/src/app/api/auth/`, `app/src/components/AuthSessionProvider.tsx` |
