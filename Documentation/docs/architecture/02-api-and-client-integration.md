...
| :--- | :--- | :--- | :--- |
| `/api/regulations` | GET | `app/src/lib/data.ts` seed | Optional `?source=fca\|pra\|hmt\|eu` filter |
| `/api/regulations/{id}` | GET | `app/src/lib/data.ts` seed | 404 if not found, 400 if `id` isn't an integer |
| `/api/audit` | GET | `app/src/lib/data.ts` seed | |
| `/api/impact` | GET | `app/src/lib/data.ts` seed | |
| `/api/jurisdictions` | GET | `app/src/lib/data.ts` seed | |
